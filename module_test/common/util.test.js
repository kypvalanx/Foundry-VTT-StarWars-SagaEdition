            ...
            describe("util", ()=>{
                ...
                describe("resolveExpression", ()=>{
                    it("should handle no parameters", async ()=>{
                        ...
                        assert.equal(2, resolveExpression("+2", null))
                        assert.equal(-5, resolveExpression("-5", null))
                        assert.equal(-10, resolveExpression("-5-5", null))
                        assert.equal("3d6 + 3", resolveExpression("3d6+3", null))
                        assert.equal(0, resolveExpression("-5--5", null))
                        assert.equal(5, resolveExpression("MAX(1,5)", null))
                        assert.equal(1, resolveExpression("MIN(1,5)", null))
                        assert.equal(8, resolveExpression("MAX(1,5)+3", null))
                        assert.equal(8, resolveExpression("MAX(1,MAX(2,5))+3", null))
